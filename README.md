...
plugins/postman/                  the plugin
  ...
  skills/<name>/                  one skill per directory (bootstrap, api-discovery, api-testing, api-mocking, api-monitoring, ci-integration, performance-testing, spec-authoring, collection-schema-v3, postman-mcp-fallback, ...)
    SKILL.md
